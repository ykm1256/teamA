					...
					<div class="row">
						<div class="col-12">
									...
									<div class="col-md-6 col-xs-12 col-lg-4">
										<div class="card border-0" id="card${item.num}">
											...
											<div class="card-body p-0 pt-2">
												<h5 class="card-title mb-1 ml-2"><a class="text-dark text-decoration-none" href="boardView.do?num=${item.num}">${item.title }</a></h5>
												...
												<div class="row">
													<div class="row ml-1 mr-1 pl-1 likebutton">
														...
														<div>
															<svg id="heart-svg" viewBox="467 392 58 57" xmlns="http://www.w3.org/2000/svg" style="width: 40px">
			                              <g id="Group" fill="none" fill-rule="evenodd" transform="translate(467 392)">
			                                ...
			                                <g id="grp1" opacity="0" transform="translate(24)">
			                                  ...
			                                  <circle id="oval2" fill="#9FC7FA" cx="7.5" cy="2" r="2" />
													...
													<div class="row m-0">
														<i class="far fa-comment-dots fa-lg mt-2 ml-3 text-muted" style="pointer-events: none"></i>
								...
								<ul class="pagination mt-5 ml-5 justify-content-center">
									...
									<c:choose>
										<c:when test="${nowBlock>1 }">
											<li class="page-item"><a class="page-link" href="movePhoto.do?next=${nowBlock-1 }">&lt;</a></li>
										</c:when>
										<c:otherwise>
									...
									<c:forEach var="i" begin="${pageStart }" end="${pageEnd-1 }">
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item"><a class="page-link text-primary" onclick="pageing('${sessionScope.keyWord}',${i})">${i }</a></li>
											</c:otherwise>
										</c:choose>
									...
									<c:choose>
										<c:when test="${totalBlock>nowBlock }">
											<li class="page-item"><a class="page-link text-muted" href="movePhoto.do?next=${nowBlock+1 }">&gt;</a></li>
										</c:when>
										<c:otherwise>
											<li class="page-item"><a class="page-link" style="pointer-events: none">&gt;</a></li>
										</c:otherwise>
							...
							<div class="row justify-content-center mb-5">
								...
								<input type="text" name="keyWord" class="mr-2" id="keyWord"> <input type="button" class="btn btn-primary" value="검색" onClick="searchCheck()">
							</div>
						</div>
						<!-- ============================================================== -->
						<!-- End PAge Content -->
