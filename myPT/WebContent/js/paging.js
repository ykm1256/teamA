...
pager.prototype = {
  renderpager: function (totalCnt, buttonClickCallback) {
    ...
    //처음, 이전 버튼 추가
    $pager
      .append(this.renderButton("first", totalPageCnt, _.buttonClickCallback))
    ...
    //다음, 마지막 버튼 추가
    $pager
      .append(this.renderButton("next", totalPageCnt, _.buttonClickCallback))
  ...
  renderButton: function (buttonLabel, totalPageCnt, buttonClickCallback) {
    var _ = this;
    var currentPage = this.opts.currentPage;
